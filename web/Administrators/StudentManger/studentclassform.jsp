...
<body>
<div class="container">
    <h3 style="text-align: center">学生课程列表</h3>
    <div style="float:left">
       <%-- <form class="form-inline" action="${pageContext.request.contextPath}/FindStudentCourseByPageServlet"
            ...
            <div class="form-group">
                <label for="exampleInputName4">课名</label>&lt;%&ndash;<label>中的for 和 <input>的id 对应 &ndash;%&gt;
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination">
                ...
                <li>
                    ...
                    <a href="${pageContext.request.contextPath}/findOneForm?currentPage=${pb.currentPage-1}&rows=5&username=${user}"
                       aria-label="Previous">
                ...
                <c:forEach begin="1" end="${pb.totalPage}" var="i">
                    <c:if test="${pb.currentPage == i}">
                        <li class="active"><a
                                href="${pageContext.request.contextPath}/findOneForm?currentPage=${i}&rows=5&username=${user}}">${i}</a>
                        </li>
                    </c:if>
                    <c:if test="${pb.currentPage != i}">
                        <li>
                            <a href="${pageContext.request.contextPath}/findOneForm?currentPage=${i}&rows=5&username=${user}}">${i}</a>
                        </li>
                    </c:if>
                </c:forEach>
                <li>
